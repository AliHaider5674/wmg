...
use App\Shopify\Converters\ToLocal\Map\OrderBillingAddressMap;
use App\Shopify\Converters\ToLocal\Map\OrderShippingAddressMap;

/**
 * @class OrderBillingAddressConverter
 ...
 */
class OrderBillingAddressConverter extends BaseSingleConverter
{
    /**
     * @param \App\Shopify\Converters\ToLocal\Map\OrderBillingAddressMap $map
     * @param \App\DataMapper\DataExtractor                              $dataExtractor
     * @param \App\Models\OrderAddress                                   $orderAddress
     */
    public function __construct(
        OrderBillingAddressMap $map,
