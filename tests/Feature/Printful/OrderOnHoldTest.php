...
/**
 * Class OrderOnHoldTest
 * @package Tests\Feature\Printful
 */
class OrderOnHoldTest extends TestCase
{
    /**
     * Order data
     */
     ...
     * @group onhold
     */
    public function testOrderOnHoldEventHandleSendsHoldSoapRequestToMagento(): void
    {
        ...
        $event = $printfulEventGenerator->createHoldEvent($order);
        ...
        $fulfillmentHoldAckData = $this->printfulApiHelper
        ...
        $this->m1SoapClient->expects('fulfillmentAck')
            ->with(
                ...
                $fulfillmentHoldAckData
            );


        $this->artisan('wmg:fulfillment pf.hold');
